module.exports = function ({ ENGLISH_EXCLAMATIONS, ENGLISH_NOUNS, ENGLISH_PROPER_NOUNS, ENGLISH_HONORIFICS, ENGLISH_VERBS, ENGLISH_ADJECTIVES, ENGLISH_ADVERBS, ENGLISH_PARTICLES, ENGLISH_MISTAKES, ENGLISH_FOREIGN, ENGLISH_ALL }) {
    ...
    function generateColorizedHTMLForEnglish (text="") {
        ...
        for(var i = 0; i < parsed.length; i++) {
            ...
            if(ENGLISH_FOREIGN.includes(parsed[i].word.toLowerCase())) {
                out += " ifd-foreign";
            }
            if(!(
